...
#include "FuryRoadSportsCar.h"
#include "FuryRoadSportsWheelFront.h"
#include "FuryRoadSportsWheelRear.h"
...
AFuryRoadSportsCar::AFuryRoadSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFuryRoadSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFuryRoadSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFuryRoadSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFuryRoadSportsWheelRear::StaticClass();
