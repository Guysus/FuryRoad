...
#include "FuryRoadOffroadCar.h"
#include "FuryRoadOffroadWheelFront.h"
#include "FuryRoadOffroadWheelRear.h"
...
AFuryRoadOffroadCar::AFuryRoadOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFuryRoadOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFuryRoadOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFuryRoadOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFuryRoadOffroadWheelRear::StaticClass();
